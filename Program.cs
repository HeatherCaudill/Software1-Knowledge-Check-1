        ...
        static void Main(string[] args)
        {
            ...
            switch (input)
            {
                ...
                case "3":
                    ...
                    if (int.TryParse(multiplyNumber1, out int multiplyNum1) && int.TryParse(multiplyNumber2, out int multiplyNum2))

                    {
                        Console.Write($"{multiplyNumber1} * {multiplyNumber2} =");
                        Console.Write(calculator.Multiply(multiplyNum1, multiplyNum2));
                    }
                    else
                    {
                        Console.WriteLine("One or more of the numbers is not an int");
